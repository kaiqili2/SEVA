...
def train(fasta_file="../data/Uniprot_train.fasta",
    ...
    test_data = ProteinDataset(fasta_file="../data/Uniprot_test.fasta", label_file="../data/label_test.txt",
                               msa_path="../data/msa_feature256/", pdb_path="../data/pdb/",
                               feature_path="../data/other_feature/")

    test_dataloader = DataLoader(test_data, batch_size=batch_size, shuffle=False, drop_last=False, num_workers=10)
    ...
    for epoch in range(epoch_n):
        ...
        test_acc = evaluation(test_dataloader, model, device)
        ...
        print("Epoch {}| Loss: {:.4f}| Train accuracy: {:.4f}| Validation accuracy: {:.4f}| Test accuracy: {:.4f}".format(epoch, training_running_loss / (i + 1), train_acc / (i + 1), val_acc, test_acc))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--fasta_file", type=str, default="../data/Uniprot_train.fasta", help="fasta file with all train data")
    parser.add_argument("--label_file", type=str, default="../data/label_train.txt", help="label of all train data")
